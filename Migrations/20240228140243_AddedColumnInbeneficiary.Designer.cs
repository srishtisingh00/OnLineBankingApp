...
namespace OnLineBankingApp.Migrations
{
    ...
    [Migration("20240228140243_AddedColumnInbeneficiary")]
    partial class AddedColumnInbeneficiary
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnLineBankingApp.Models.AccountType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnLineBankingApp.Models.Beneficiary", b =>
                {
            ...
            modelBuilder.Entity("OnLineBankingApp.Models.ChequeBook", b =>
                {
            ...
            modelBuilder.Entity("OnLineBankingApp.Models.Gender", b =>
                {
                    b.Property<int>("GenderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnLineBankingApp.Models.Login", b =>
                {
            ...
            modelBuilder.Entity("OnLineBankingApp.Models.RoleType", b =>
                {
                    b.Property<int>("RoleTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnLineBankingApp.Models.SecurityQuestion", b =>
                {
                    b.Property<int>("SqId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnLineBankingApp.Models.Status", b =>
                {
                    b.Property<int>("StatusID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnLineBankingApp.Models.TransactionType", b =>
                {
                    b.Property<int>("TraId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnLineBankingApp.Models.Account", b =>
                {
                    b.HasOne("OnLineBankingApp.Models.AccountType", "AccountType")
                        .WithMany("Accounts")
            ...
            modelBuilder.Entity("OnLineBankingApp.Models.ChequeBook", b =>
                {
                    ...
                    b.HasOne("OnLineBankingApp.Models.Status", "Status")
                        .WithMany("ChequeBooks")
            ...
            modelBuilder.Entity("OnLineBankingApp.Models.Customer", b =>
                {
                    b.HasOne("OnLineBankingApp.Models.Gender", "Gender")
                        .WithMany("Customers")
                        .HasForeignKey("GenderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OnLineBankingApp.Models.RoleType", "RoleType")
                        .WithMany("Customer")
            ...
            modelBuilder.Entity("OnLineBankingApp.Models.Login", b =>
                {
                    b.HasOne("OnLineBankingApp.Models.SecurityQuestion", null)
                        .WithMany("Login")
            ...
            modelBuilder.Entity("OnLineBankingApp.Models.Transaction", b =>
                {
                    b.HasOne("OnLineBankingApp.Models.Account", "Accounts")
                        .WithMany("Transactions")
                        .HasForeignKey("AccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OnLineBankingApp.Models.Beneficiary", "Beneficiary")
                        .WithMany("Transactions")
                    ...
                    b.HasOne("OnLineBankingApp.Models.TransactionType", "TransactionType")
                        .WithMany("Transactions")
