...
namespace OnLineBankingApp.Controllers
{
    public class AccountsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AccountId,CustomerID,Id,Balance,DateOfOpening")] Account account)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AccountId,CustomerID,Id,Balance,DateOfOpening")] Account account)
        {
